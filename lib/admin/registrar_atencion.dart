...
class _RegistrarAtencionPageState extends State<RegistrarAtencionPage>
  ...
  void _cargarHorasOcupadas(String fecha) async {
    try {
      final snapshot = await FirebaseFirestore.instance
        ...
        _pacientesList.isNotEmpty
            ? Container(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  onChanged: (valor) {
                    setState(() {
                      _selectedPacienteId = valor;
                      _selectedPacienteNombre = _pacientesList.firstWhere(
                        (pac) => pac['id'] == valor,
                      )['nombre'];
                    });
                  },
  ...
  Widget _dropdownTriaje() {
    Color getTriajeColor(String? triaje) {
      switch (triaje) {
        case 'Verde':
          return Colors.green;
        case 'Amarillo':
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownButtonFormField<String>(
            ...
            items: ['Verde', 'Amarillo', 'Rojo'].map((triaje) {
              final color = getTriajeColor(triaje);
            ...
            onChanged: (value) => setState(() => _triaje = value),
